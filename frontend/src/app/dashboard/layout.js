        ...
        <div className="space-y-8">
          ...
          <div className="relative">
            <button
              ...
              className="w-12 h-12 rounded-full overflow-hidden border-2 border-white shadow-md hover:scale-105 active:scale-95 transition-all duration-200 block cursor-pointer focus:outline-none"
            >
              <img
                key={avatar}
